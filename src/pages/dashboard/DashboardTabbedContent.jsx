...
import '../../index.css';
import TabbedContentLink from '../../components/elements/dashboard/TabbedContentLink';
                ...
                <div className="w-full mt-6">
                    <div>
                        <ul className="flex border-b">
                            <TabbedContentLink tabNumber={1} openTab={openTab} setOpenTab={setOpenTab}>Tab 1</TabbedContentLink>
                            <TabbedContentLink tabNumber={2} openTab={openTab} setOpenTab={setOpenTab}>Tab 2</TabbedContentLink>
                            <TabbedContentLink tabNumber={3} openTab={openTab} setOpenTab={setOpenTab}>Tab 3</TabbedContentLink>
                            <TabbedContentLink tabNumber={4} openTab={openTab} setOpenTab={setOpenTab}>Tab 4</TabbedContentLink>
                        </ul>
                    </div>
